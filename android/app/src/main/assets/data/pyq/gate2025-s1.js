...
window.GATE_DATA.pyq.push({
  ...
  questions: [
    { id: 'gate2025s1-ga-1', n: 1, section: 'GA',
    ...
    { id: 'gate2025s1-ga-2', n: 2, section: 'GA',
    ...
    { id: 'gate2025s1-ga-3', n: 3, section: 'GA',
    ...
    { id: 'gate2025s1-ga-4', n: 4, section: 'GA',
    ...
    { id: 'gate2025s1-ga-6', n: 6, section: 'GA',
    ...
    { id: 'gate2025s1-ga-8', n: 8, section: 'GA',
    ...
    { id: 'gate2025s1-ga-10', n: 10, section: 'GA',
    ...
    { id: 'gate2025s1-cs-11', n: 11, section: 'CS',
    ...
    { id: 'gate2025s1-cs-12', n: 12, section: 'CS',
    ...
    { id: 'gate2025s1-cs-13', n: 13, section: 'CS',
    ...
    { id: 'gate2025s1-cs-14', n: 14, section: 'CS',
    ...
    { id: 'gate2025s1-cs-15', n: 15, section: 'CS',
    ...
    { id: 'gate2025s1-cs-16', n: 16, section: 'CS',
    ...
    { id: 'gate2025s1-cs-17', n: 17, section: 'CS',
    ...
    { id: 'gate2025s1-cs-18', n: 18, section: 'CS',
    ...
    { id: 'gate2025s1-cs-19', n: 19, section: 'CS',
    ...
    { id: 'gate2025s1-cs-20', n: 20, section: 'CS',
    ...
    { id: 'gate2025s1-cs-22', n: 22, section: 'CS',
    ...
    { id: 'gate2025s1-cs-23', n: 23, section: 'CS',
    ...
    { id: 'gate2025s1-cs-24', n: 24, section: 'CS',
    ...
    { id: 'gate2025s1-cs-25', n: 25, section: 'CS',
    ...
    { id: 'gate2025s1-cs-26', n: 26, section: 'CS',
    ...
    { id: 'gate2025s1-cs-28', n: 28, section: 'CS',
    ...
    { id: 'gate2025s1-cs-29', n: 29, section: 'CS',
      ...
      options: [], answer: 21, tolerance: 0.01, kind: 'nat', marks: 1,
    ...
    { id: 'gate2025s1-cs-30', n: 30, section: 'CS',
      ...
      options: [], answer: 195, tolerance: 0.01, kind: 'nat', marks: 1,
    ...
    { id: 'gate2025s1-cs-31', n: 31, section: 'CS',
      ...
      options: [], answer: -2, tolerance: 0.1, kind: 'nat', marks: 1,
    ...
    { id: 'gate2025s1-cs-32', n: 32, section: 'CS',
    ...
    { id: 'gate2025s1-cs-33', n: 33, section: 'CS',
      ...
      options: [], answer: 435, tolerance: 0.01, kind: 'nat', marks: 1,
    ...
    { id: 'gate2025s1-cs-36', n: 36, section: 'CS',
    ...
    { id: 'gate2025s1-cs-37', n: 37, section: 'CS',
    ...
    { id: 'gate2025s1-cs-38', n: 38, section: 'CS',
    ...
    { id: 'gate2025s1-cs-39', n: 39, section: 'CS',
    ...
    { id: 'gate2025s1-cs-41', n: 41, section: 'CS',
    ...
    { id: 'gate2025s1-cs-42', n: 42, section: 'CS',
    ...
    { id: 'gate2025s1-cs-43', n: 43, section: 'CS',
    ...
    { id: 'gate2025s1-cs-44', n: 44, section: 'CS',
    ...
    { id: 'gate2025s1-cs-45', n: 45, section: 'CS',
    ...
    { id: 'gate2025s1-cs-46', n: 46, section: 'CS',
    ...
    { id: 'gate2025s1-cs-47', n: 47, section: 'CS',
    ...
    { id: 'gate2025s1-cs-48', n: 48, section: 'CS',
    ...
    { id: 'gate2025s1-cs-49', n: 49, section: 'CS',
    ...
    { id: 'gate2025s1-cs-51', n: 51, section: 'CS',
      ...
      options: [], answer: 65468, tolerance: 0.01, kind: 'nat', marks: 2,
    ...
    { id: 'gate2025s1-cs-52', n: 52, section: 'CS',
      ...
      options: [], answer: 6, tolerance: 0.01, kind: 'nat', marks: 2,
    ...
    { id: 'gate2025s1-cs-54', n: 54, section: 'CS',
    ...
    { id: 'gate2025s1-cs-56', n: 56, section: 'CS',
    ...
    { id: 'gate2025s1-cs-59', n: 59, section: 'CS',
      ...
      options: [], answer: 5, tolerance: 0.01, kind: 'nat', marks: 2,
    ...
    { id: 'gate2025s1-cs-61', n: 61, section: 'CS',
    ...
    { id: 'gate2025s1-cs-63', n: 63, section: 'CS',
      q: '#include <stdio.h>\nint gate(int n) {\n  int d, t, newnum, turn;\n  newnum = turn = 0;\n  t=1;\n  while (n>=t) t *= 10;\n  t /= 10;\n  while (t>0) {\n    d = n/t;\n    n = n%t;\n    t /= 10;\n    if (turn) newnum = 10*newnum + d;\n    turn = (turn + 1) % 2;\n  }\n  return newnum;\n}\nint main() {\n  printf("%d", gate(14362));\n  return 0;\n}\nThe value printed by the given C program is _______. (Answer in integer)',
      options: [], answer: 46, tolerance: 0.01, kind: 'nat', marks: 2,
    ...
    { id: 'gate2025s1-cs-65', n: 65, section: 'CS',
