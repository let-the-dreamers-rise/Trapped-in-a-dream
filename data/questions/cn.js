...
},
{
  ...
  figure: '<svg viewBox="0 0 300 123" width="100%" style="max-width:380px;height:auto" xmlns="http://www.w3.org/2000/svg"><rect x="40" y="20" width="220" height="50" fill="none" stroke="currentColor"/><text x="4" y="86" font-size="13" text-anchor="start" fill="currentColor">192.168.10.0 / 28</text><text x="4" y="104" font-size="10" text-anchor="start" fill="currentColor">Subnet mask: 255.255.255.240</text></svg>',
  options: ['16', '14', '30', '8'],
  answer: 1,
  marks: 1,
  difficulty: 'easy',
...
window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-transport';}).questions.push(
  {
    ...
    difficulty: 'hard',
    type: 'numerical',
    explanation: "Trace cwnd (in MSS) round by round, applying the rule exactly as stated: slow start DOUBLES each RTT but is CAPPED at ssthresh, and once cwnd reaches that cap the growth becomes linear (+1 MSS per RTT). Phase 1 (ssthresh = 16): RTT1=1, RTT2=2, RTT3=4, RTT4=8, and RTT5 doubles 8 to 16, which is exactly the cap, so RTT5=16 is the LAST slow-start round. Congestion avoidance then adds 1 per round: RTT6=17, RTT7=18. A timeout occurs at the END of RTT7, when cwnd = 18, so the new ssthresh = floor(18/2) = 9 and cwnd resets to 1. Phase 2 (ssthresh = 9): RTT8=1, RTT9=2, RTT10=4, RTT11=8; RTT12 would double 8 to 16 but is capped at ssthresh, so RTT12=9 and slow start ends there. A triple-duplicate-ACK arrives at the END of RTT12 with cwnd = 9, so the new ssthresh = floor(9/2) = 4 and fast recovery sets cwnd = 4. Phase 3: RTT13=4, and congestion avoidance resumes, so RTT14 = 4+1 = 5. The full 14-round trace is 1, 2, 4, 8, 16, 17, 18, 1, 2, 4, 8, 9, 4, 5, summing to 99 MSS. Total bytes = 99 x 512 = 50,688 bytes. The traps are: cwnd REACHES the cap rather than stopping one doubling short of it (8 goes to 16, not to 9 - slow start ends AT ssthresh, as the chapter's slow-start rule states), the halving uses the cwnd value AT the moment of loss detection (18 and 9, not the round before), and a timeout collapses cwnd to 1 while a triple-duplicate-ACK only drops it to the new ssthresh."
  },
  {
    id: 'cn-transport-h2',
...
window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-basics';}).theory.figs = [
  { id: 'osi-stack', caption: 'Encapsulation as data descends the stack', svg: "<svg viewBox=\"0 0 400 162\" width=\"100%\" style=\"max-width:440px;height:auto\" xmlns=\"http://www.w3.org/2000/svg\">\n<text x=\"10\" y=\"16\" font-size=\"12\" font-weight=\"bold\" fill=\"currentColor\">Encapsulation down the stack</text>\n<rect x=\"10\" y=\"28\" width=\"380\" height=\"22\" fill=\"none\" stroke=\"currentColor\"/>\n<text x=\"20\" y=\"43\" font-size=\"11\" fill=\"currentColor\">Application: DATA</text>\n<rect x=\"10\" y=\"56\" width=\"380\" height=\"22\" fill=\"none\" stroke=\"currentColor\"/>\n<rect x=\"10\" y=\"56\" width=\"34\" height=\"22\" fill=\"none\" stroke=\"#35d0ba\"/>\n<text x=\"13\" y=\"71\" font-size=\"9\" fill=\"#35d0ba\">TCP</text>\n<text x=\"50\" y=\"71\" font-size=\"11\" fill=\"currentColor\">DATA (segment)</text>\n<rect x=\"10\" y=\"84\" width=\"380\" height=\"22\" fill=\"none\" stroke=\"currentColor\"/>\n<rect x=\"10\" y=\"84\" width=\"34\" height=\"22\" fill=\"none\" stroke=\"#35d0ba\"/>\n<rect x=\"44\" y=\"84\" width=\"34\" height=\"22\" fill=\"none\" stroke=\"#ec3013\"/>\n<text x=\"13\" y=\"99\" font-size=\"9\" fill=\"#35d0ba\">TCP</text>\n<text x=\"48\" y=\"99\" font-size=\"9\" fill=\"#ec3013\">IP</text>\n<text x=\"84\" y=\"99\" font-size=\"11\" fill=\"currentColor\">DATA (packet)</text>\n<rect x=\"10\" y=\"112\" width=\"380\" height=\"22\" fill=\"none\" stroke=\"currentColor\"/>\n<rect x=\"10\" y=\"112\" width=\"34\" height=\"22\" fill=\"none\" stroke=\"#35d0ba\"/>\n<rect x=\"44\" y=\"112\" width=\"34\" height=\"22\" fill=\"none\" stroke=\"#ec3013\"/>\n<rect x=\"78\" y=\"112\" width=\"26\" height=\"22\" fill=\"none\" stroke=\"currentColor\"/>\n<text x=\"13\" y=\"127\" font-size=\"9\" fill=\"#35d0ba\">TCP</text>\n<text x=\"48\" y=\"127\" font-size=\"9\" fill=\"#ec3013\">IP</text>\n<text x=\"80\" y=\"127\" font-size=\"8\" fill=\"currentColor\">MAC</text>\n<text x=\"110\" y=\"127\" font-size=\"11\" fill=\"currentColor\">DATA (frame)</text>\n<text x=\"10\" y=\"150\" font-size=\"10\" fill=\"currentColor\">Each layer adds a header; data link adds a trailer</text>\n</svg>" },
  { id: 'delay-timeline', caption: 'Transmission delay vs propagation delay', svg: "<svg viewBox=\"0 0 400 170\" width=\"100%\" style=\"max-width:440px;height:auto\" xmlns=\"http://www.w3.org/2000/svg\">\n<text x=\"10\" y=\"16\" font-size=\"12\" font-weight=\"bold\" fill=\"currentColor\">Transmission vs propagation delay</text>\n<text x=\"10\" y=\"40\" font-size=\"11\" fill=\"currentColor\">Sender</text>\n<line x1=\"60\" y1=\"40\" x2=\"380\" y2=\"40\" stroke=\"currentColor\"/>\n<rect x=\"60\" y=\"30\" width=\"60\" height=\"16\" fill=\"none\" stroke=\"#35d0ba\"/>\n<text x=\"65\" y=\"42\" font-size=\"9\" fill=\"#35d0ba\">Tt (push bits)</text>\n<text x=\"10\" y=\"110\" font-size=\"11\" fill=\"currentColor\">Receiver</text>\n<line x1=\"60\" y1=\"110\" x2=\"380\" y2=\"110\" stroke=\"currentColor\"/>\n<rect x=\"180\" y=\"100\" width=\"60\" height=\"16\" fill=\"none\" stroke=\"#ec3013\"/>\n<text x=\"182\" y=\"112\" font-size=\"9\" fill=\"#ec3013\">last bit arrives</text>\n<line x1=\"120\" y1=\"46\" x2=\"240\" y2=\"100\" stroke=\"currentColor\" stroke-dasharray=\"3,2\"/>\n<text x=\"130\" y=\"75\" font-size=\"10\" fill=\"currentColor\">Tp (propagation)</text>\n<line x1=\"60\" y1=\"55\" x2=\"60\" y2=\"120\" stroke=\"currentColor\" stroke-dasharray=\"2,2\"/>\n<line x1=\"120\" y1=\"55\" x2=\"120\" y2=\"120\" stroke=\"currentColor\" stroke-dasharray=\"2,2\"/>\n<line x1=\"240\" y1=\"55\" x2=\"240\" y2=\"120\" stroke=\"currentColor\" stroke-dasharray=\"2,2\"/>\n<text x=\"55\" y=\"132\" font-size=\"9\" fill=\"currentColor\">t=0</text>\n<text x=\"112\" y=\"132\" font-size=\"9\" fill=\"currentColor\">t=Tt</text>\n<text x=\"222\" y=\"132\" font-size=\"9\" fill=\"currentColor\">t=Tt+Tp</text>\n<text x=\"10\" y=\"155\" font-size=\"10\" fill=\"currentColor\">Total one-hop delay = Tt + Tp (independent components)</text>\n</svg>" }
];
(function(){ var t = window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-basics';});
  t.theory.core = t.theory.core.replace('Delay arithmetic. For a packet of L bits', '[[FIG:delay-timeline]]\n\nDelay arithmetic. For a packet of L bits'); })();
(function(){ var t = window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-basics';});
  t.theory.core = t.theory.core.replace('Encapsulation. At the sender', '[[FIG:osi-stack]]\n\nEncapsulation. At the sender'); })();

window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-datalink';}).theory.figs = [
  { id: 'sliding-window', caption: 'Sliding window sender/receiver timeline', svg: "<svg viewBox=\"0 0 400 145\" width=\"100%\" style=\"max-width:440px;height:auto\" xmlns=\"http://www.w3.org/2000/svg\">\n<text x=\"10\" y=\"16\" font-size=\"12\" font-weight=\"bold\" fill=\"currentColor\">Sliding window (W=4) timeline</text>\n<text x=\"10\" y=\"36\" font-size=\"11\" fill=\"currentColor\">Sender</text>\n<line x1=\"60\" y1=\"36\" x2=\"380\" y2=\"36\" stroke=\"currentColor\"/>\n<rect x=\"60\" y=\"28\" width=\"24\" height=\"14\" fill=\"none\" stroke=\"#35d0ba\"/>\n<rect x=\"86\" y=\"28\" width=\"24\" height=\"14\" fill=\"none\" stroke=\"#35d0ba\"/>\n<rect x=\"112\" y=\"28\" width=\"24\" height=\"14\" fill=\"none\" stroke=\"#35d0ba\"/>\n<rect x=\"138\" y=\"28\" width=\"24\" height=\"14\" fill=\"none\" stroke=\"#35d0ba\"/>\n<text x=\"62\" y=\"39\" font-size=\"8\" fill=\"#35d0ba\">1</text>\n<text x=\"88\" y=\"39\" font-size=\"8\" fill=\"#35d0ba\">2</text>\n<text x=\"114\" y=\"39\" font-size=\"8\" fill=\"#35d0ba\">3</text>\n<text x=\"140\" y=\"39\" font-size=\"8\" fill=\"#35d0ba\">4</text>\n<text x=\"170\" y=\"39\" font-size=\"9\" fill=\"currentColor\">window sent before any ACK</text>\n<text x=\"10\" y=\"100\" font-size=\"11\" fill=\"currentColor\">Receiver</text>\n<line x1=\"60\" y1=\"100\" x2=\"380\" y2=\"100\" stroke=\"currentColor\"/>\n<line x1=\"84\" y1=\"42\" x2=\"60\" y2=\"94\" stroke=\"currentColor\" stroke-dasharray=\"3,2\"/>\n<line x1=\"162\" y1=\"42\" x2=\"200\" y2=\"94\" stroke=\"#ec3013\" stroke-dasharray=\"3,2\"/>\n<circle cx=\"200\" cy=\"94\" r=\"3\" fill=\"#ec3013\"/>\n<text x=\"205\" y=\"98\" font-size=\"9\" fill=\"#ec3013\">ACK 1</text>\n<line x1=\"200\" y1=\"94\" x2=\"230\" y2=\"42\" stroke=\"#ec3013\" stroke-dasharray=\"3,2\"/>\n<rect x=\"220\" y=\"28\" width=\"24\" height=\"14\" fill=\"none\" stroke=\"#35d0ba\"/>\n<text x=\"222\" y=\"39\" font-size=\"8\" fill=\"#35d0ba\">5</text>\n<text x=\"10\" y=\"130\" font-size=\"10\" fill=\"currentColor\">Cycle = Tt + 2Tp. Utilization U = W/(1+2a), a = Tp/Tt</text>\n</svg>" },
  { id: 'crc-division', caption: 'CRC XOR long division', svg: "<svg viewBox=\"0 0 400 195\" width=\"100%\" style=\"max-width:440px;height:auto\" xmlns=\"http://www.w3.org/2000/svg\">\n<text x=\"10\" y=\"16\" font-size=\"12\" font-weight=\"bold\" fill=\"currentColor\">CRC: append r zeros, XOR-divide by generator</text>\n<text x=\"10\" y=\"40\" font-size=\"13\" fill=\"currentColor\">Message:</text>\n<text x=\"90\" y=\"40\" font-size=\"13\" fill=\"currentColor\">1 1 0 1</text>\n<text x=\"10\" y=\"60\" font-size=\"13\" fill=\"currentColor\">+ r zeros:</text>\n<text x=\"90\" y=\"60\" font-size=\"13\" fill=\"currentColor\">1 1 0 1 0 0 0</text>\n<text x=\"240\" y=\"60\" font-size=\"10\" fill=\"currentColor\">(r = degree of generator)</text>\n<line x1=\"90\" y1=\"70\" x2=\"270\" y2=\"70\" stroke=\"currentColor\"/>\n<text x=\"10\" y=\"90\" font-size=\"13\" fill=\"#35d0ba\">Generator:</text>\n<text x=\"90\" y=\"90\" font-size=\"13\" fill=\"#35d0ba\">1 0 1 1</text>\n<text x=\"10\" y=\"115\" font-size=\"12\" fill=\"currentColor\">XOR long division, bit by bit -----</text>\n<text x=\"10\" y=\"135\" font-size=\"12\" fill=\"currentColor\">Remainder (r bits) replaces the appended zeros</text>\n<rect x=\"10\" y=\"145\" width=\"90\" height=\"20\" fill=\"none\" stroke=\"#ec3013\"/>\n<text x=\"20\" y=\"159\" font-size=\"12\" fill=\"#ec3013\">e.g. 0 1 0</text>\n<text x=\"110\" y=\"159\" font-size=\"10\" fill=\"currentColor\">= transmitted frame's check bits</text>\n<text x=\"10\" y=\"182\" font-size=\"10\" fill=\"currentColor\">Receiver divides received frame by generator; remainder 0 = accept</text>\n</svg>" },
  { id: 'csma-cd', caption: 'CSMA/CD worst-case collision timing', svg: "<svg viewBox=\"0 0 400 145\" width=\"100%\" style=\"max-width:440px;height:auto\" xmlns=\"http://www.w3.org/2000/svg\">\n<text x=\"10\" y=\"16\" font-size=\"12\" font-weight=\"bold\" fill=\"currentColor\">CSMA/CD: worst-case collision detection</text>\n<text x=\"10\" y=\"40\" font-size=\"11\" fill=\"currentColor\">A</text>\n<line x1=\"30\" y1=\"40\" x2=\"380\" y2=\"40\" stroke=\"currentColor\"/>\n<rect x=\"30\" y=\"32\" width=\"150\" height=\"14\" fill=\"none\" stroke=\"#35d0ba\"/>\n<text x=\"35\" y=\"43\" font-size=\"9\" fill=\"#35d0ba\">A transmits</text>\n<text x=\"10\" y=\"100\" font-size=\"11\" fill=\"currentColor\">B</text>\n<line x1=\"30\" y1=\"100\" x2=\"380\" y2=\"100\" stroke=\"currentColor\"/>\n<rect x=\"150\" y=\"92\" width=\"90\" height=\"14\" fill=\"none\" stroke=\"#35d0ba\"/>\n<text x=\"155\" y=\"103\" font-size=\"9\" fill=\"#35d0ba\">B transmits (t=Tp)</text>\n<line x1=\"30\" y1=\"46\" x2=\"150\" y2=\"92\" stroke=\"currentColor\" stroke-dasharray=\"3,2\"/>\n<circle cx=\"150\" cy=\"92\" r=\"4\" fill=\"#ec3013\"/>\n<text x=\"158\" y=\"82\" font-size=\"9\" fill=\"#ec3013\">collision at B</text>\n<line x1=\"150\" y1=\"98\" x2=\"180\" y2=\"46\" stroke=\"#ec3013\" stroke-dasharray=\"3,2\"/>\n<circle cx=\"180\" cy=\"46\" r=\"4\" fill=\"#ec3013\"/>\n<text x=\"186\" y=\"44\" font-size=\"9\" fill=\"#ec3013\">A hears jam at t=2Tp</text>\n<text x=\"10\" y=\"130\" font-size=\"10\" fill=\"currentColor\">A must still be transmitting at 2Tp: Tt &gt;= 2Tp, so Lmin = 2 x Tp x R</text>\n</svg>" }
];
(function(){ var t = window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-datalink';});
  t.theory.core = t.theory.core.replace('Sliding windows. Define Tt', '[[FIG:sliding-window]]\n\nSliding windows. Define Tt'); })();
(function(){ var t = window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-datalink';});
  t.theory.core = t.theory.core.replace('CRC treats the message as a polynomial', '[[FIG:crc-division]]\n\nCRC treats the message as a polynomial'); })();
(function(){ var t = window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-datalink';});
  t.theory.core = t.theory.core.replace('CSMA/CD and Ethernet. A station listens', '[[FIG:csma-cd]]\n\nCSMA/CD and Ethernet. A station listens'); })();

window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-network';}).theory.figs = [
  { id: 'ipv4-header', caption: 'IPv4 header field layout', svg: "<svg viewBox=\"0 0 400 136\" width=\"100%\" style=\"max-width:440px;height:auto\" xmlns=\"http://www.w3.org/2000/svg\">\n<style>.a{fill:none;stroke:currentColor}.b{fill:none;stroke:#35d0ba}.c{fill:none;stroke:#ec3013}.t{font-size:9px;fill:currentColor}.tb{font-size:9px;fill:#35d0ba}.tc{font-size:10px;fill:#ec3013}</style>\n<text x=\"10\" y=\"14\" font-size=\"12\" font-weight=\"bold\" fill=\"currentColor\">IPv4 header layout</text>\n<rect class=\"a\" x=\"10\" y=\"22\" width=\"90\" height=\"18\"/>\n<rect class=\"a\" x=\"100\" y=\"22\" width=\"90\" height=\"18\"/>\n<rect class=\"a\" x=\"190\" y=\"22\" width=\"200\" height=\"18\"/>\n<text class=\"t\" x=\"14\" y=\"35\">Ver(4)</text>\n<text class=\"t\" x=\"104\" y=\"35\">HLEN(4)</text>\n<text class=\"t\" x=\"230\" y=\"35\">Total length(16)</text>\n<rect class=\"b\" x=\"10\" y=\"40\" width=\"190\" height=\"18\"/>\n<rect class=\"b\" x=\"200\" y=\"40\" width=\"90\" height=\"18\"/>\n<rect class=\"b\" x=\"290\" y=\"40\" width=\"100\" height=\"18\"/>\n<text class=\"tb\" x=\"14\" y=\"53\">ID(16)</text>\n<text class=\"tb\" x=\"204\" y=\"53\">Flags(3)</text>\n<text class=\"tb\" x=\"294\" y=\"53\">Frag offset(13)</text>\n<rect class=\"a\" x=\"10\" y=\"58\" width=\"90\" height=\"18\"/>\n<rect class=\"a\" x=\"100\" y=\"58\" width=\"90\" height=\"18\"/>\n<rect class=\"a\" x=\"190\" y=\"58\" width=\"200\" height=\"18\"/>\n<text class=\"t\" x=\"14\" y=\"71\">TTL(8)</text>\n<text class=\"t\" x=\"104\" y=\"71\">Proto(8)</text>\n<text class=\"t\" x=\"220\" y=\"71\">Checksum(16)</text>\n<rect class=\"c\" x=\"10\" y=\"76\" width=\"380\" height=\"18\"/>\n<text class=\"tc\" x=\"90\" y=\"89\">Source IP (32 bits)</text>\n<rect class=\"c\" x=\"10\" y=\"94\" width=\"380\" height=\"18\"/>\n<text class=\"tc\" x=\"80\" y=\"107\">Destination IP (32 bits)</text>\n<text x=\"10\" y=\"126\" font-size=\"10\" fill=\"currentColor\">Offset is in 8-byte units; ID matches across fragments</text>\n</svg>" },
  { id: 'subnet-split', caption: 'Subnet splitting of an address block', svg: "<svg viewBox=\"0 0 400 152\" width=\"100%\" style=\"max-width:440px;height:auto\" xmlns=\"http://www.w3.org/2000/svg\">\n<text x=\"10\" y=\"16\" font-size=\"12\" font-weight=\"bold\" fill=\"currentColor\">Subnetting: 192.168.16.0/24 into four /26 blocks</text>\n<rect x=\"10\" y=\"28\" width=\"380\" height=\"30\" fill=\"none\" stroke=\"currentColor\"/>\n<text x=\"120\" y=\"47\" font-size=\"11\" fill=\"currentColor\">192.168.16.0 /24 (256 addresses)</text>\n<line x1=\"10\" y1=\"70\" x2=\"10\" y2=\"80\" stroke=\"currentColor\"/>\n<line x1=\"105\" y1=\"58\" x2=\"105\" y2=\"80\" stroke=\"currentColor\" stroke-dasharray=\"2,2\"/>\n<line x1=\"200\" y1=\"58\" x2=\"200\" y2=\"80\" stroke=\"currentColor\" stroke-dasharray=\"2,2\"/>\n<line x1=\"295\" y1=\"58\" x2=\"295\" y2=\"80\" stroke=\"currentColor\" stroke-dasharray=\"2,2\"/>\n<line x1=\"390\" y1=\"70\" x2=\"390\" y2=\"80\" stroke=\"currentColor\"/>\n<rect x=\"10\" y=\"82\" width=\"95\" height=\"34\" fill=\"none\" stroke=\"#35d0ba\"/>\n<rect x=\"105\" y=\"82\" width=\"95\" height=\"34\" fill=\"none\" stroke=\"#35d0ba\"/>\n<rect x=\"200\" y=\"82\" width=\"95\" height=\"34\" fill=\"none\" stroke=\"#35d0ba\"/>\n<rect x=\"295\" y=\"82\" width=\"95\" height=\"34\" fill=\"none\" stroke=\"#35d0ba\"/>\n<text x=\"15\" y=\"97\" font-size=\"9\" fill=\"#35d0ba\">.0/26</text>\n<text x=\"15\" y=\"110\" font-size=\"8\" fill=\"currentColor\">62 hosts</text>\n<text x=\"110\" y=\"97\" font-size=\"9\" fill=\"#35d0ba\">.64/26</text>\n<text x=\"110\" y=\"110\" font-size=\"8\" fill=\"currentColor\">62 hosts</text>\n<text x=\"205\" y=\"97\" font-size=\"9\" fill=\"#35d0ba\">.128/26</text>\n<text x=\"205\" y=\"110\" font-size=\"8\" fill=\"currentColor\">62 hosts</text>\n<text x=\"300\" y=\"97\" font-size=\"9\" fill=\"#35d0ba\">.192/26</text>\n<text x=\"300\" y=\"110\" font-size=\"8\" fill=\"currentColor\">62 hosts</text>\n<text x=\"10\" y=\"140\" font-size=\"10\" fill=\"currentColor\">2 borrowed bits -> 4 subnets; each has 2^6-2 = 62 usable hosts</text>\n</svg>" },
  { id: 'fragmentation', caption: 'Fragmenting a datagram with offsets', svg: "<svg viewBox=\"0 0 400 152\" width=\"100%\" style=\"max-width:440px;height:auto\" xmlns=\"http://www.w3.org/2000/svg\">\n<text x=\"10\" y=\"16\" font-size=\"12\" font-weight=\"bold\" fill=\"currentColor\">Fragmenting 2980 data bytes, MTU payload 1200</text>\n<rect x=\"10\" y=\"26\" width=\"380\" height=\"24\" fill=\"none\" stroke=\"currentColor\"/>\n<text x=\"140\" y=\"42\" font-size=\"10\" fill=\"currentColor\">Original datagram: 2980 data bytes</text>\n<text x=\"180\" y=\"65\" font-size=\"14\" fill=\"currentColor\">|</text>\n<rect x=\"10\" y=\"76\" width=\"152\" height=\"26\" fill=\"none\" stroke=\"#35d0ba\"/>\n<text x=\"20\" y=\"93\" font-size=\"9\" fill=\"#35d0ba\">Frag1: 1200 bytes</text>\n<rect x=\"166\" y=\"76\" width=\"152\" height=\"26\" fill=\"none\" stroke=\"#35d0ba\"/>\n<text x=\"176\" y=\"93\" font-size=\"9\" fill=\"#35d0ba\">Frag2: 1200 bytes</text>\n<rect x=\"322\" y=\"76\" width=\"68\" height=\"26\" fill=\"none\" stroke=\"#ec3013\"/>\n<text x=\"328\" y=\"93\" font-size=\"8\" fill=\"#ec3013\">Frag3: 580</text>\n<text x=\"10\" y=\"118\" font-size=\"9\" fill=\"currentColor\">offset=0, MF=1</text>\n<text x=\"166\" y=\"118\" font-size=\"9\" fill=\"currentColor\">offset=150, MF=1</text>\n<text x=\"322\" y=\"118\" font-size=\"9\" fill=\"#ec3013\">offset=300, MF=0</text>\n<text x=\"10\" y=\"140\" font-size=\"10\" fill=\"currentColor\">Offset = first data byte / 8. Last fragment carries the remainder, MF=0</text>\n</svg>" }
];
(function(){ var t = window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-network';});
  t.theory.core = t.theory.core.replace('IPv4 header. Minimum 20 bytes', '[[FIG:ipv4-header]]\n\nIPv4 header. Minimum 20 bytes'); })();
(function(){ var t = window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-network';});
  t.theory.core = t.theory.core.replace('Fragmentation. A router fragments', '[[FIG:fragmentation]]\n\nFragmentation. A router fragments'); })();
(function(){ var t = window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-network';});
  t.theory.core = t.theory.core.replace('CIDR and subnetting. A /p network', '[[FIG:subnet-split]]\n\nCIDR and subnetting. A /p network'); })();

window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-transport';}).theory.figs = [
  { id: 'tcp-hs', caption: 'TCP three-way handshake and teardown', svg: "<svg viewBox=\"0 0 400 215\" width=\"100%\" style=\"max-width:440px;height:auto\" xmlns=\"http://www.w3.org/2000/svg\">\n<text x=\"10\" y=\"14\" font-size=\"12\" font-weight=\"bold\" fill=\"currentColor\">TCP handshake and teardown</text>\n<text x=\"30\" y=\"30\" font-size=\"11\" fill=\"currentColor\">Client</text>\n<text x=\"330\" y=\"30\" font-size=\"11\" fill=\"currentColor\">Server</text>\n<line x1=\"50\" y1=\"24\" x2=\"50\" y2=\"210\" stroke=\"currentColor\"/>\n<line x1=\"350\" y1=\"24\" x2=\"350\" y2=\"210\" stroke=\"currentColor\"/>\n<line x1=\"50\" y1=\"42\" x2=\"350\" y2=\"58\" stroke=\"#35d0ba\"/>\n<text x=\"130\" y=\"38\" font-size=\"9\" fill=\"#35d0ba\">SYN seq=x</text>\n<line x1=\"350\" y1=\"66\" x2=\"50\" y2=\"82\" stroke=\"#35d0ba\"/>\n<text x=\"115\" y=\"80\" font-size=\"9\" fill=\"#35d0ba\">SYN+ACK seq=y,ack=x+1</text>\n<line x1=\"50\" y1=\"90\" x2=\"350\" y2=\"106\" stroke=\"#35d0ba\"/>\n<text x=\"130\" y=\"104\" font-size=\"9\" fill=\"#35d0ba\">ACK ack=y+1</text>\n<text x=\"150\" y=\"122\" font-size=\"9\" fill=\"currentColor\">-- data transfer --</text>\n<line x1=\"50\" y1=\"140\" x2=\"350\" y2=\"156\" stroke=\"#ec3013\"/>\n<text x=\"150\" y=\"138\" font-size=\"9\" fill=\"#ec3013\">FIN seq=p</text>\n<line x1=\"350\" y1=\"160\" x2=\"50\" y2=\"172\" stroke=\"#ec3013\"/>\n<text x=\"150\" y=\"172\" font-size=\"9\" fill=\"#ec3013\">ACK p+1</text>\n<line x1=\"350\" y1=\"180\" x2=\"50\" y2=\"192\" stroke=\"#ec3013\"/>\n<text x=\"150\" y=\"178\" font-size=\"9\" fill=\"#ec3013\">FIN seq=q</text>\n<line x1=\"50\" y1=\"196\" x2=\"350\" y2=\"208\" stroke=\"#ec3013\"/>\n<text x=\"150\" y=\"206\" font-size=\"9\" fill=\"#ec3013\">ACK q+1</text>\n</svg>" },
  { id: 'cwnd-curve', caption: 'Congestion window vs RTT', svg: "<svg viewBox=\"0 0 400 212\" width=\"100%\" style=\"max-width:440px;height:auto\" xmlns=\"http://www.w3.org/2000/svg\">\n<text x=\"10\" y=\"14\" font-size=\"12\" font-weight=\"bold\" fill=\"currentColor\">cwnd vs time: slow start, AIMD, timeout</text>\n<line x1=\"40\" y1=\"170\" x2=\"390\" y2=\"170\" stroke=\"currentColor\"/>\n<line x1=\"40\" y1=\"170\" x2=\"40\" y2=\"20\" stroke=\"currentColor\"/>\n<text x=\"5\" y=\"24\" font-size=\"9\" fill=\"currentColor\">cwnd</text>\n<text x=\"370\" y=\"185\" font-size=\"9\" fill=\"currentColor\">RTT</text>\n<line x1=\"40\" y1=\"130\" x2=\"40\" y2=\"30\" stroke=\"currentColor\" stroke-dasharray=\"2,2\"/>\n<text x=\"44\" y=\"112\" font-size=\"8\" fill=\"currentColor\">ssthresh</text>\n<path d=\"M40,160 L70,150 L100,130 L130,100 L150,90\" stroke=\"#35d0ba\" fill=\"none\" stroke-width=\"2\"/>\n<text x=\"55\" y=\"145\" font-size=\"8\" fill=\"#35d0ba\">slow start (doubling)</text>\n<path d=\"M150,90 L200,78 L250,68 L290,60\" stroke=\"#35d0ba\" fill=\"none\" stroke-width=\"2\"/>\n<text x=\"190\" y=\"55\" font-size=\"8\" fill=\"#35d0ba\">AIMD (+1/RTT)</text>\n<circle cx=\"290\" cy=\"60\" r=\"4\" fill=\"#ec3013\"/>\n<line x1=\"290\" y1=\"60\" x2=\"290\" y2=\"163\" stroke=\"#ec3013\" stroke-dasharray=\"2,2\"/>\n<text x=\"270\" y=\"70\" font-size=\"8\" fill=\"#ec3013\">timeout</text>\n<path d=\"M290,163 L320,150 L340,130 L360,120\" stroke=\"#35d0ba\" fill=\"none\" stroke-width=\"2\"/>\n<text x=\"10\" y=\"200\" font-size=\"9\" fill=\"currentColor\">Timeout: ssthresh=cwnd/2, cwnd resets to 1 MSS</text>\n</svg>" }
];
(function(){ var t = window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-transport';});
  t.theory.core = t.theory.core.replace('Connection establishment: the 3-way handshake.', '[[FIG:tcp-hs]]\n\nConnection establishment: the 3-way handshake.'); })();
(function(){ var t = window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-transport';});
  t.theory.core = t.theory.core.replace('Congestion control. TCP maintains a congestion window', '[[FIG:cwnd-curve]]\n\nCongestion control. TCP maintains a congestion window'); })();

window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-application';}).theory.figs = [
  { id: 'dns-resolution', caption: 'DNS recursive vs iterative resolution', svg: "<svg viewBox=\"0 0 400 158\" width=\"100%\" style=\"max-width:440px;height:auto\" xmlns=\"http://www.w3.org/2000/svg\">\n<text x=\"10\" y=\"14\" font-size=\"12\" font-weight=\"bold\" fill=\"currentColor\">DNS: recursive query, iterative lookups</text>\n<circle cx=\"40\" cy=\"60\" r=\"16\" fill=\"none\" stroke=\"currentColor\"/>\n<text x=\"24\" y=\"63\" font-size=\"8\" fill=\"currentColor\">Client</text>\n<circle cx=\"140\" cy=\"30\" r=\"16\" fill=\"none\" stroke=\"currentColor\"/>\n<text x=\"118\" y=\"33\" font-size=\"8\" fill=\"currentColor\">Resolver</text>\n<circle cx=\"260\" cy=\"30\" r=\"14\" fill=\"none\" stroke=\"#35d0ba\"/>\n<text x=\"245\" y=\"33\" font-size=\"8\" fill=\"#35d0ba\">Root</text>\n<circle cx=\"330\" cy=\"60\" r=\"14\" fill=\"none\" stroke=\"#35d0ba\"/>\n<text x=\"312\" y=\"63\" font-size=\"8\" fill=\"#35d0ba\">TLD</text>\n<circle cx=\"330\" cy=\"110\" r=\"14\" fill=\"none\" stroke=\"#35d0ba\"/>\n<text x=\"298\" y=\"113\" font-size=\"8\" fill=\"#35d0ba\">Authoritative</text>\n<line x1=\"55\" y1=\"55\" x2=\"126\" y2=\"35\" stroke=\"#ec3013\"/>\n<text x=\"60\" y=\"48\" font-size=\"8\" fill=\"#ec3013\">recursive query (1 ask)</text>\n<line x1=\"154\" y1=\"32\" x2=\"248\" y2=\"30\" stroke=\"#35d0ba\"/>\n<text x=\"160\" y=\"24\" font-size=\"7\" fill=\"#35d0ba\">1: iterative</text>\n<line x1=\"270\" y1=\"38\" x2=\"322\" y2=\"55\" stroke=\"#35d0ba\"/>\n<text x=\"272\" y=\"50\" font-size=\"7\" fill=\"#35d0ba\">2</text>\n<line x1=\"330\" y1=\"74\" x2=\"330\" y2=\"96\" stroke=\"#35d0ba\"/>\n<text x=\"334\" y=\"88\" font-size=\"7\" fill=\"#35d0ba\">3</text>\n<line x1=\"126\" y1=\"40\" x2=\"55\" y2=\"65\" stroke=\"currentColor\" stroke-dasharray=\"2,2\"/>\n<text x=\"60\" y=\"78\" font-size=\"8\" fill=\"currentColor\">final answer</text>\n<text x=\"10\" y=\"145\" font-size=\"10\" fill=\"currentColor\">Client-resolver leg is recursive; resolver-hierarchy legs are iterative</text>\n</svg>" },
  { id: 'http-timeline', caption: 'HTTP RTT cost across connection modes', svg: "<svg viewBox=\"0 0 400 122\" width=\"100%\" style=\"max-width:440px;height:auto\" xmlns=\"http://www.w3.org/2000/svg\">\n<style>.b{fill:none;stroke:#35d0ba}.c{fill:none;stroke:#ec3013}</style>\n<text x=\"10\" y=\"14\" font-size=\"12\" font-weight=\"bold\" fill=\"currentColor\">HTTP RTT cost by connection mode</text>\n<text x=\"10\" y=\"34\" font-size=\"10\" fill=\"currentColor\">Non-persistent:</text>\n<rect class=\"c\" x=\"160\" y=\"24\" width=\"26\" height=\"14\"/>\n<text x=\"163\" y=\"35\" font-size=\"7\" fill=\"#ec3013\">conn</text>\n<rect class=\"c\" x=\"188\" y=\"24\" width=\"26\" height=\"14\"/>\n<text x=\"192\" y=\"35\" font-size=\"7\" fill=\"#ec3013\">GET</text>\n<text x=\"220\" y=\"35\" font-size=\"9\" fill=\"currentColor\">per object = 2 RTT</text>\n<text x=\"10\" y=\"60\" font-size=\"10\" fill=\"currentColor\">Persistent, no pipeline:</text>\n<rect class=\"b\" x=\"200\" y=\"50\" width=\"22\" height=\"14\"/>\n<text x=\"202\" y=\"61\" font-size=\"6\" fill=\"#35d0ba\">setup</text>\n<rect class=\"b\" x=\"224\" y=\"50\" width=\"22\" height=\"14\"/>\n<rect class=\"b\" x=\"248\" y=\"50\" width=\"22\" height=\"14\"/>\n<rect class=\"b\" x=\"272\" y=\"50\" width=\"22\" height=\"14\"/>\n<text x=\"300\" y=\"61\" font-size=\"9\" fill=\"currentColor\">= 1+1+n RTT</text>\n<text x=\"10\" y=\"86\" font-size=\"10\" fill=\"currentColor\">Pipelined:</text>\n<rect class=\"b\" x=\"200\" y=\"76\" width=\"22\" height=\"14\"/>\n<text x=\"202\" y=\"87\" font-size=\"6\" fill=\"#35d0ba\">setup</text>\n<rect class=\"b\" x=\"224\" y=\"76\" width=\"22\" height=\"14\"/>\n<rect class=\"b\" x=\"248\" y=\"76\" width=\"56\" height=\"14\"/>\n<text x=\"250\" y=\"87\" font-size=\"7\" fill=\"#35d0ba\">all n objects</text>\n<text x=\"310\" y=\"87\" font-size=\"9\" fill=\"currentColor\">= 3 RTT</text>\n<text x=\"10\" y=\"112\" font-size=\"9\" fill=\"currentColor\">Base HTML always costs 1 RTT before objects are known</text>\n</svg>" }
];
(function(){ var t = window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-application';});
  t.theory.core = t.theory.core.replace('DNS. The Domain Name System resolves names', '[[FIG:dns-resolution]]\n\nDNS. The Domain Name System resolves names'); })();
(function(){ var t = window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-application';});
  t.theory.core = t.theory.core.replace('HTTP connections. Non-persistent HTTP', '[[FIG:http-timeline]]\n\nHTTP connections. Non-persistent HTTP'); })();

(function(){ var t = window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-basics';});
  t.theory.deep += "\n\nFROM ZERO: FOUNDATIONS\n• Bit vs Byte. A **bit** is a single 0 or 1, the smallest unit of digital information. A **byte** is 8 bits. Networking speeds are almost always quoted in bits per second; storage sizes are almost always quoted in bytes.\nGATE TRAP: 1 Mbps = 10^6 bits per second (decimal, networking convention), but 1 MB (megabyte, storage) commonly uses 1 MB = 2^20 bytes = 1,048,576 bytes. Mixing these two conventions inside one delay computation is the single most common silent-killer mistake on CN numericals -- always convert everything to bits using powers of 10 for RATES and be careful whether a SIZE is quoted in decimal or binary units.\nKEY: Unit ladder -- 1 byte = 8 bits. 1 Kbps = 10^3 bps. 1 Mbps = 10^6 bps. 1 Gbps = 10^9 bps. 1 KB (file size) = 2^10 bytes = 1024 bytes (unless the question explicitly says decimal KB).\n• Bandwidth. **Bandwidth** is the maximum rate at which a link can carry bits, e.g. 10 Mbps means the link can push 10 million bits every second, no more.\n• Protocol. A **protocol** is an agreed set of rules two communicating parties follow so that what one sends is understood the same way by the other -- like a shared language plus a shared procedure for turn-taking.\n• Header. A **header** is extra control information (source/destination address, sequence number, checksum, type of the payload, etc.) that a layer prepends to the data it receives from the layer above, so that a peer entity at the same layer on the far end can interpret the payload correctly.\n• Encapsulation. **Encapsulation** is the process of wrapping data with a header (and sometimes a trailer) at each layer as it travels down the stack for transmission. At the receiver, each layer strips off and reads only its own header before passing the remainder up -- this is decapsulation.\nKEY: PDU (protocol data unit) naming as data descends -- Application: message/data -> Transport: segment (TCP) or datagram (UDP) -> Network: packet (IP datagram) -> Data Link: frame -> Physical: bits.\n\nEVERY EDGE CASE\n• Four delay components, never confuse them. **Transmission delay** = time to push all bits of a packet onto the link = L/R (L = packet size in bits, R = link rate in bps) -- this depends on packet size and link speed, NOT distance. **Propagation delay** = time for one bit to travel across the physical medium = d/v (d = distance, v = propagation speed in the medium, roughly 2x10^8 m/s in copper/fibre) -- this depends on distance, NOT packet size. **Queueing delay** = time a packet waits in a router's buffer before it can be transmitted -- depends on traffic load, unpredictable, often given directly in a question or assumed 0. **Processing delay** = time a router takes to examine the header and decide where to forward the packet -- usually small and often given as a constant or ignored.\nGATE TRAP: swapping transmission and propagation delay in a formula is the #1 conceptual trap. A larger packet increases transmission delay only; a longer cable increases propagation delay only; increasing link speed R DECREASES transmission delay but leaves propagation delay unchanged.\n• Store-and-forward across multiple links. A router must receive an ENTIRE packet before it starts forwarding even the first bit onward (store-and-forward), so crossing k links costs k separate transmission delays, not one.\nKEY: End-to-end delay for ONE packet across k links (ignoring queueing/processing) = k x (L/R) + k x (d/v), i.e. sum every link's transmission delay plus every link's propagation delay.\n• Pipelining with many packets. If a message of size M is split into n packets of size L each (n = M/L) and sent back-to-back over k links, the LAST packet's arrival time is NOT n x k x (L/R); because packets pipeline through the links, later packets overlap with earlier ones still finishing their trip. The correct count is (n + k - 1) transmission-delay-sized slots, plus one final propagation delay term.\nFORMULA: Total time (ignoring propagation) = (n + k - 1) x (L/R)\n• Circuit switching vs packet switching. **Circuit switching** reserves a fixed path and bandwidth for the whole call duration (used in old telephone networks) -- guaranteed bandwidth but wasted capacity during silence, and a SETUP delay is paid before any data flows. **Packet switching** (used in the Internet) has no reservation -- packets share links on demand, giving better statistical multiplexing but variable (queueing) delay and possible loss.\nGATE TRAP: a common question asks 'which one is more suitable for bursty traffic' -- packet switching wins because idle senders don't hog reserved capacity; but for GUARANTEED, jitter-free bandwidth (e.g. traditional voice), circuit switching wins.\n• Acknowledgement bits are not free. When a problem says 'ignore ACK transmission time', that is stated explicitly because in the real formula an ACK packet also has its own (usually small but non-zero) transmission delay that should be added when computing round-trip completion times, unless told otherwise.\n\nWORKED EXAMPLE -- store-and-forward with pipelining\nA message of size M = 7,500,000 bits must be sent from a source to a destination across 3 links (so k = 3, meaning 2 intermediate routers), each of rate R = 10 Mbps. The message is broken into packets of L = 15,000 bits each. Assume propagation delay is negligible and there is no queueing.\n1. step: Find number of packets. n = M / L = 7,500,000 / 15,000 = 500 packets.\n2. step: Find transmission delay per hop for one packet. L/R = 15,000 / 10,000,000 = 0.0015 s = 1.5 ms.\n3. step: Apply the pipelining formula. Total time = (n + k - 1) x (L/R) = (500 + 3 - 1) x 1.5 ms = 502 x 1.5 ms.\n4. step: Compute. 502 x 1.5 = 753 ms.\nREMEMBER: if the question instead sends the WHOLE message as one giant packet (no splitting), the time would be just k x (M/R) -- always check whether the message is split before picking a formula, since the two answers differ hugely (here 3 x 750 ms = 2250 ms vs the pipelined 753 ms).\n\nWORKED EXAMPLE -- bandwidth-delay product\nA link has bandwidth R = 2 Mbps and one-way propagation delay of 20 ms.\n1. step: Bandwidth-delay product = R x propagation delay = 2x10^6 x 0.02 = 40,000 bits.\n2. step: Interpret it -- this is the maximum number of bits that can be 'in flight' on the wire at any instant, i.e. the pipe's capacity, before the first bit even arrives at the receiver.\nKEY: Bandwidth-delay product = R x Tprop (bits). This single number decides the minimum window size needed to keep a link 100% utilized in sliding-window protocols -- covered fully under cn-transport.\n\nWORKED EXAMPLE -- classifying layer duties (fast one-mark drill)\n1. step: 'Reliable, in-order delivery of a byte stream between two processes' -> Transport layer (TCP).\n2. step: 'Choosing the best path across multiple networks using logical addresses' -> Network layer (IP, routing).\n3. step: 'Framing bits into frames and detecting/correcting bit errors on one physical hop' -> Data Link layer.\n4. step: 'Converting bits into electrical/optical/radio signals' -> Physical layer.\n5. step: 'HTTP, DNS, SMTP as user-facing services' -> Application layer.\nGATE TRAP: encryption, compression and character-encoding translation belong to the OSI **presentation** layer, which the TCP/IP model does not have as a separate layer -- in TCP/IP these jobs are folded into the application layer. A question phrased as 'which TCP/IP layer does encryption belong to' expects the answer application, NOT a nonexistent presentation layer.\n";
})();

(function(){ var t = window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-datalink';});
  t.theory.deep += "\n\nFROM ZERO: FOUNDATIONS\n• Frame. A **frame** is the data-link-layer unit -- the network-layer packet wrapped with a link-layer header (source/destination MAC address, type field) and often a trailer (a checksum called the FCS, frame check sequence) used to detect transmission errors on that one physical hop.\n• Sequence number. A **sequence number** is a small integer tag put on each frame so the receiver can tell frames apart, detect duplicates, and know which ones have not yet been acknowledged. It is stored in a field of some fixed size k bits, so it can only take values 0 to 2^k - 1 before it must repeat (wrap around).\n• Sliding window. A **sliding window** protocol lets a sender transmit multiple frames before waiting for an acknowledgement (unlike stop-and-wait, which sends one frame and waits), so the link stays busy instead of idling during the round-trip time. The 'window' is the set of sequence numbers the sender is currently allowed to have outstanding (unacknowledged).\n• Error control vs flow control. **Error control** means detecting/recovering from corrupted or lost frames (checksums, retransmission). **Flow control** means preventing a fast sender from overwhelming a slow receiver's buffer (achieved by the window size).\n\nEVERY EDGE CASE\n• Why efficiency needs a window at all. In stop-and-wait, the sender is idle for almost the entire round-trip time after sending one frame, so link utilization U = Ttrans / (Ttrans + 2xTprop), which is tiny when Tprop >> Ttrans (a 'fat, long' pipe). Sliding window fixes this by keeping multiple frames in flight.\nFORMULA: Stop-and-wait utilization U = Tt / (Tt + 2Tp)\n• Sequence number wraparound. Because the sequence field is only k bits wide, numbers cycle 0,1,...,2^k-1,0,1,... The window size must be small enough that the receiver can never confuse a NEW frame carrying a wrapped-around sequence number with an OLD, already-accepted frame carrying the same number.\n• Go-Back-N (GBN) window limit. In GBN the receiver only accepts frames strictly in order and discards anything out of order (keeping only a single 'expected sequence number' state), so the constraint to avoid ambiguity is looser.\nFORMULA: GBN max sender window size = 2^k - 1\nGATE TRAP: students often write 2^k for GBN -- it is 2^k - 1. With k=3 bits, the max window is 7, not 8; a window of 8 would let a brand-new frame 0 be confused with an old, un-acknowledged frame 0 still sitting at the same sequence slot.\n• Selective Repeat (SR) window limit. SR lets the receiver buffer out-of-order frames individually (it needs to remember the exact status -- received or not -- of every sequence number in its receive window), which is a stricter requirement, so the safe window is smaller.\nFORMULA: SR max sender window size = 2^(k-1) (receiver window size must equal sender window size, both = 2^(k-1))\nGATE TRAP: a favourite trick question gives k and asks for GBN and SR window sizes together, expecting 2^k - 1 and 2^(k-1) respectively -- mixing these up is a guaranteed lost mark. Also remember SR window = 2^(k-1) requires sender window size = receiver window size (unlike GBN where only the sender window is bounded that way).\n• Minimum frame size in CSMA/CD (Ethernet-style contention). For collision detection to work, the sender must still be transmitting when the collision signal (from the far end of the cable) gets back to it -- i.e. transmission time must be at least the round-trip propagation time.\nFORMULA: Lmin = 2 x Tprop x R (Tprop = one-way propagation delay across the whole collision domain, R = data rate)\nGATE TRAP: whenever a question changes the cable length OR the data rate, the minimum frame size changes too (since Tprop and R both appear in the formula) -- recompute, never reuse a memorised '512 bits' / '64 bytes' Ethernet-specific number for a different R or d given in the problem.\n• Bit stuffing edge case. In bit-oriented framing (HDLC-style) that uses the flag pattern 01111110 to mark frame boundaries, the sender inserts a 0 after any run of five consecutive 1s in the data so the flag pattern never appears inside the payload by accident; the receiver removes (destuffs) any 0 that follows five 1s. A GATE numerical often asks you to compute the number of bits AFTER stuffing given a data bit pattern -- count every run of five 1s, including runs that span across what looks like a boundary.\n• CRC and Hamming code edge cases. A CRC of r check bits can detect all burst errors of length <= r, and it CANNOT detect an error pattern that exactly equals the generator polynomial itself (an error polynomial that is a multiple of the generator). A Hamming code with r redundant bits can correct any single-bit error only if 2^r >= m + r + 1 (m = number of message bits) -- this inequality, not a memorized bit count, is what GATE tests.\n\nWORKED EXAMPLE -- Go-Back-N full trace with a lost frame\nA sender uses GBN with k=3 sequence bits (window size = 2^3-1 = 7) and sends frames F0..F6 back to back.\n1. step: Sender transmits F0,F1,F2,F3,F4,F5,F6 (fills the whole window of 7).\n2. step: Suppose F2 is lost in transit; the receiver correctly gets F0, F1, then gets F3 out of order.\n3. step: Because GBN receivers only accept in-order frames, F3 (and every later frame that arrives before F2) is discarded, even though it was received correctly.\n4. step: The receiver keeps re-sending an ACK for the last correctly-received in-order frame (ACK1) for every out-of-order arrival (cumulative ACK).\n5. step: When the sender's timer for F2 expires, it must retransmit F2, F3, F4, F5, F6 -- the ENTIRE window from the lost frame onward, even though F3-F6 physically reached the receiver once already. This wasted retransmission of already-delivered frames is exactly the trade-off GBN makes for a simple 1-bit receiver state, versus SR's more expensive per-frame buffering.\n\nWORKED EXAMPLE -- minimum frame size recompute\nA CSMA/CD LAN has a maximum cable length of 2 km between the two farthest stations, signal speed 2x10^8 m/s, and data rate 10 Mbps.\n1. step: One-way propagation delay Tprop = distance / speed = 2000 / 2x10^8 = 10 microseconds.\n2. step: Minimum frame size Lmin = 2 x Tprop x R = 2 x 10x10^-6 x 10x10^6 = 200 bits = 25 bytes.\n3. step: If the SAME network instead used 100 Mbps with the same 2 km length, Lmin = 2 x 10x10^-6 x 100x10^6 = 2000 bits = 250 bytes -- ten times bigger, because higher speed pushes bits out faster, so more bits are needed to keep the wire 'busy' long enough for the collision signal to return.\nGATE TRAP: this is exactly why Fast Ethernet and Gigabit Ethernet had to either shrink the maximum cable length or use frame bursting/carrier extension -- keeping the old 64-byte minimum frame with a higher data rate would break collision detection.\n\nWORKED EXAMPLE -- Selective Repeat sequence numbering\nA link uses SR with k=2 sequence bits, so 2^k = 4 possible sequence numbers {0,1,2,3}, and the safe max window is 2^(k-1) = 2.\n1. step: Sender window = receiver window = 2 (both must match in SR).\n2. step: Sender transmits F0, F1 (window full at 2 outstanding frames), receiver acks each individually as they arrive, buffering out-of-order ones instead of discarding.\n3. step: If the window were mistakenly set to 3 (violating 2^(k-1)=2), sequence numbers would wrap fast enough that a stale retransmitted F0 sitting in the receiver's buffer could be misinterpreted as a brand-new F0 -- exactly the ambiguity the 2^(k-1) bound exists to prevent.\nKEY: memorise the pair together -- GBN: 2^k - 1, SR: 2^(k-1) -- so on the exam you instantly know which is roughly HALF the sequence space and which is almost the WHOLE sequence space.\n";
})();

(function(){ var t = window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-network';});
  t.theory.deep += "\n\nFROM ZERO: FOUNDATIONS\n• IP address. An **IP address** (IPv4) is a 32-bit number, usually written as four 8-bit chunks separated by dots (dotted-decimal), e.g. 192.168.1.10 -- it identifies a host's interface on a network, made of a network part and a host part.\n• Subnet mask / prefix length. A **subnet mask** marks which leading bits of the address are the network part. Writing /p (e.g. /24) means the first p bits are the network part and the remaining (32-p) bits are the host part.\n• Datagram / packet. A **datagram** (or IP packet) is the network-layer PDU: an IP header (containing source IP, destination IP, TTL, protocol, fragmentation fields, checksum) wrapped around the transport-layer segment handed down to it.\n• Routing vs forwarding. **Routing** is the control-plane process of building/exchanging information to decide the best path (e.g. via a routing algorithm like distance vector or link state). **Forwarding** is the fast data-plane action of moving an arriving packet from an input port to the correct output port based on a lookup in the routing/forwarding table.\n\nEVERY EDGE CASE\n• Number of usable hosts in a subnet. A subnet with h host bits has 2^h total addresses, but TWO of them are reserved: the all-0s host part is the **network address** (identifies the subnet itself) and the all-1s host part is the **broadcast address** (reaches every host on that subnet) -- neither can be assigned to a host.\nFORMULA: Usable hosts per subnet = 2^h - 2\nGATE TRAP: forgetting to subtract 2 is the most common subnetting arithmetic error -- a /27 subnet has 2^5=32 addresses but only 30 usable hosts, not 32.\n• Subnet zero and the all-ones subnet. Classically, the very first subnet of a block (the 'subnet zero', all subnet bits 0) and the very last subnet (all subnet bits 1) were sometimes disallowed by old equipment, but modern CIDR-compliant systems (and GATE, unless it explicitly says otherwise) DO allow both as valid, usable subnets -- do not discard them unless the question says so.\n• Sizing a subnet from a host-count requirement. Given 'we need at least N hosts per subnet', find the smallest h such that 2^h - 2 >= N; do not just take log2(N) directly, since N is rarely a clean power of 2 minus 2.\nGATE TRAP: for N=25 hosts, 2^4-2=14 is too small, so you must go to 2^5-2=30 -- always ROUND UP to the next valid block size, never round down or split the difference.\n• Fragmentation fields. Every IP header carries an **identification** field (same value for all fragments of one original datagram), a **DF (Don't Fragment)** bit (if set, a router that cannot forward the datagram unfragmented must drop it and send back an ICMP error, instead of fragmenting), an **MF (More Fragments)** bit (1 on every fragment except the last), and a 13-bit **fragment offset** field measured in units of 8 BYTES (not 1 byte).\nGATE TRAP: the offset field is in units of 8 bytes, so a fragment's actual byte offset = (offset field value) x 8. Also, the data length carried by every fragment except possibly the last MUST be a multiple of 8 bytes, because the next fragment's offset must land on an 8-byte boundary.\n• Total fragments needed. Given a datagram of D data bytes and a link MTU of M bytes (with H-byte IP header per fragment), max data per fragment = floor((M - H)/8) x 8 (rounded down to a multiple of 8), and the number of fragments = ceil(D / maxDataPerFragment).\n• Reassembly only happens at the final destination. Fragments are NOT reassembled at intermediate routers in IPv4 -- only the destination host reassembles them, using the identification field to group fragments and the offset+MF fields to order them and know when the last one has arrived.\n• Longest prefix match. When a routing table has multiple matching entries for a destination address (e.g. both a /16 and a /24 entry match), the router must choose the entry with the LONGEST matching prefix (most specific), not the first match in the table or the shortest one.\nGATE TRAP: a numerical with an overlapping CIDR table is testing exactly this rule -- always pick the entry with the largest prefix length /p among all that match.\n• Distance vector count-to-infinity. In distance-vector routing (e.g. RIP), when a link fails, routers can update each other with stale, mutually-reinforcing bad information, causing the reported distance to a now-unreachable destination to slowly climb (1,2,3,...) instead of immediately reflecting infinity -- this is the count-to-infinity problem, partially mitigated by 'infinity = 16' caps and split-horizon/poison-reverse in RIP.\n\nWORKED EXAMPLE -- splitting a block into equal subnets\nAn organization owns the block 192.168.16.0/20 and must split it into exactly 4 equal-size subnets.\n1. step: A /20 block has 32-20=12 host bits, so it has 2^12 = 4096 total addresses.\n2. step: Splitting into 4 equal parts means borrowing 2 more bits for subnetting (since 2^2 = 4), giving each subnet a prefix of /20+2 = /22.\n3. step: Each /22 subnet has 32-22=10 host bits, i.e. 2^10 = 1024 addresses (1022 usable hosts).\n4. step: List the subnets by incrementing the third octet by 1024/256=4 each time: Subnet1 = 192.168.16.0/22 (usable 192.168.16.1 - 192.168.19.254, broadcast 192.168.19.255); Subnet2 = 192.168.20.0/22 (broadcast 192.168.23.255); Subnet3 = 192.168.24.0/22 (broadcast 192.168.27.255); Subnet4 = 192.168.28.0/22 (broadcast 192.168.31.255).\nKEY: block size (number of addresses) doubles for every bit LESS in the prefix, and halves for every bit MORE -- moving from /20 to /22 is 2 extra bits, so block size shrinks by a factor of 4 (4096/4=1024), matching the 4-way split required.\n\nWORKED EXAMPLE -- IP fragmentation with offsets\nAn IP datagram carries 3980 bytes of data (plus a 20-byte header, so total length 4000 bytes) and must cross a link with MTU 1500 bytes; every fragment also carries its own 20-byte IP header.\n1. step: Max data payload per fragment = MTU - header = 1500 - 20 = 1480 bytes; check it's already a multiple of 8 (1480/8=185, yes) so no further rounding needed.\n2. step: Fragment 1 carries data bytes 0..1479 (1480 bytes), offset field = 0/8 = 0, MF=1.\n3. step: Fragment 2 carries the next 1480 bytes (bytes 1480..2959), offset field = 1480/8 = 185, MF=1.\n4. step: Remaining data = 3980 - 1480 - 1480 = 1020 bytes. Fragment 3 carries these last 1020 bytes, offset field = 2960/8 = 370, MF=0 (last fragment).\n5. step: Total fragments = 3.\nGATE TRAP: a question may ask for the offset value written IN THE FIELD (370) versus the actual byte offset (370x8=2960) -- always state which one is being asked for; confusing the two loses the mark even with correct fragment sizing.\n\nWORKED EXAMPLE -- host-count-driven subnet design\nAn organization has the block 200.10.5.0/24 and needs subnets that can each support at least 25 hosts, using as many subnets as possible.\n1. step: Find smallest h with 2^h - 2 >= 25: h=4 gives 2^4-2=14 (fails); h=5 gives 2^5-2=30 (succeeds).\n2. step: So each subnet needs 5 host bits, i.e. a /27 mask (32-5=27), block size 2^5=32 addresses.\n3. step: The /24 block has 2^8=256 total addresses; number of /27 subnets that fit = 256/32 = 8 subnets.\nGATE TRAP: using h=4 (14 usable hosts) would technically allow MORE, smaller subnets (16 of them) but FAILS the 'at least 25 hosts' requirement -- always satisfy the host-count floor first, then count how many subnets of that size fit; never trade away the requirement to get a bigger subnet count.\n";
})();

(function(){ var t = window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-transport';});
  t.theory.deep += "\n\nFROM ZERO: FOUNDATIONS\n• Port number. A **port number** is a 16-bit number that identifies a specific process/application on a host, so that a single IP address can serve many simultaneous connections (e.g. a browser talking to a web server on port 80, an email client on port 25). A (source IP, source port, destination IP, destination port, protocol) 5-tuple uniquely identifies one TCP connection.\n• Segment. A **segment** is the transport-layer PDU: application data wrapped with a TCP (or UDP) header carrying source/destination ports, sequence number, acknowledgement number, window size, flags (SYN/ACK/FIN/RST), and a checksum.\n• Connection-oriented vs connectionless. TCP is **connection-oriented**: it sets up a connection (3-way handshake) before sending data and guarantees reliable, in-order, byte-stream delivery. UDP is **connectionless**: it just sends datagrams with no setup, no guarantee of delivery or order, and much lower overhead -- used where speed matters more than reliability (DNS queries, streaming, VoIP).\n• Congestion window (cwnd). **cwnd** is the sender-side limit on how much unacknowledged data may be in flight, used by TCP to avoid overloading the network (as opposed to the receiver's advertised window, rwnd, which avoids overloading the RECEIVER's buffer). The sender's actual usable window = min(cwnd, rwnd).\n\nEVERY EDGE CASE\n• ACK size is not always negligible. Many textbook formulas assume ACK transmission time is 0, but a GATE question can explicitly give an ACK size and ask you to include its transmission delay in a round-trip time computation -- always re-read whether the ACK's own L/R term is to be ignored or added.\n• TCP sequence numbers count BYTES, not segments. The sequence number in a TCP header is the byte offset of the FIRST byte of that segment's data within the overall byte stream, not a segment index -- so ack number = (seq number of received segment) + (number of data bytes in it), NOT seq+1 (except for the SYN/FIN special case where each consumes exactly 1 sequence number even though they carry no data).\nGATE TRAP: for the 3-way handshake specifically, SYN and FIN flags each consume ONE sequence number even with zero data bytes, which is why the handshake ACK is x+1, not x+(data length).\n• Slow start vs congestion avoidance boundary. TCP starts cwnd at 1 MSS and DOUBLES it every RTT (slow start) until cwnd reaches ssthresh, after which it grows by only +1 MSS per RTT (congestion avoidance, additive increase).\nFORMULA: Slow start: cwnd <- 2 x cwnd each RTT (while cwnd < ssthresh). Congestion avoidance: cwnd <- cwnd + 1 each RTT (while cwnd >= ssthresh)\n• Timeout vs triple duplicate ACK -- they are NOT the same severity. A **timeout** (no ACK at all within the timeout interval) is treated as a sign of SEVERE congestion: TCP Reno sets ssthresh = cwnd/2 and resets cwnd all the way back to 1 MSS, then restarts slow start. A **triple duplicate ACK** (3 repeated ACKs for the same byte, meaning some segments still got through) is a MILDER signal: TCP Reno performs fast retransmit + fast recovery -- ssthresh = cwnd/2 and cwnd is set directly to the NEW ssthresh (not down to 1), then continues in congestion avoidance.\nGATE TRAP: setting cwnd to 1 after a triple-dup-ack event (instead of cwnd/2) is the most common Reno-tracing mistake -- only a full timeout resets cwnd to 1.\n• Sequence number wraparound in TCP. The 32-bit TCP sequence number field wraps around after 2^32 bytes (~4.3 GB) have been sent; on very high-speed, long-delay links this can happen fast enough that an old, delayed segment could be confused with a new one carrying the same wrapped sequence number -- this is why TCP uses the PAWS (protection against wrapped sequence numbers) mechanism with timestamps on high-speed links, a fact tested conceptually rather than numerically.\n• UDP checksum optional in IPv4. UDP's checksum field is optional under IPv4 (a value of all-zero in that field means 'no checksum computed'), but it is MANDATORY under IPv6 -- a subtle fact GATE occasionally tests as a true/false statement.\n• Nagle's algorithm and delayed ACK interaction. Nagle's algorithm delays sending small segments to batch them, while delayed ACK delays sending ACKs to piggyback on data -- if both are active on two ends of a connection simultaneously, they can interact badly and stall for the whole delayed-ACK timeout; this is a qualitative GATE trap about TCP performance pitfalls, not a numeric one.\n\nWORKED EXAMPLE -- full cwnd trace across a timeout and a triple-dup-ack (TCP Reno)\nInitial ssthresh = 16 MSS, cwnd starts at 1 MSS. Assume 1 MSS worth of data is successfully acked every RTT unless a loss event is stated.\n1. step (RTT 1-4, slow start): cwnd doubles each round: RTT1=1, RTT2=2, RTT3=4, RTT4=8 (all below ssthresh=16, so slow start continues).\n2. step (RTT 5, crosses ssthresh): cwnd would double to 16, which now EQUALS ssthresh, so from here on congestion avoidance applies: RTT5=16.\n3. step (RTT 6-8, congestion avoidance, +1/RTT): RTT6=17, RTT7=18, RTT8=19.\n4. step: A TIMEOUT occurs after RTT8 (cwnd was 19 when the loss was detected). Apply timeout rule: ssthresh = floor(cwnd/2) = floor(19/2) = 9; cwnd resets to 1.\n5. step (RTT 9-12, slow start again up to the new ssthresh=9): RTT9=1, RTT10=2, RTT11=4, RTT12=8 (still below ssthresh=9, would double to 16 next -- but a loss event interrupts it here).\n6. step: A TRIPLE DUPLICATE ACK occurs at cwnd=8 (RTT12). Apply fast-recovery rule (NOT reset to 1): new ssthresh = floor(8/2) = 4; cwnd is set directly to the new ssthresh = 4, and TCP resumes congestion avoidance (not slow start) from here.\n7. step (RTT 13-14, congestion avoidance, +1/RTT): RTT13=4, RTT14=5.\nKEY: verified trace summary -- 1,2,4,8,16,17,18,19,[timeout: ssthresh=9,cwnd=1],1,2,4,8,[3-dup-ACK: ssthresh=4,cwnd=4],4,5. Notice cwnd DIPS to exactly 1 only after a timeout, and DIPS to ssthresh/2's new value (not 1) after a triple-dup-ack.\nGATE TRAP: after ANY loss event, ssthresh is always set to (cwnd at the moment of loss)/2, using the cwnd value the instant the loss is detected -- not the cwnd from the previous RTT and not the OLD ssthresh.\n\nWORKED EXAMPLE -- bandwidth-delay product deciding window size for full utilization\nA link has bandwidth 1 Mbps and round-trip time (RTT) 40 ms. Segment size (MSS) = 1000 bits.\n1. step: Bandwidth-delay product (in bits) = R x RTT = 1x10^6 x 0.04 = 40,000 bits.\n2. step: Convert to number of segments = 40,000 / 1,000 = 40 segments.\n3. step: For the link to be kept 100% busy with a sliding window, the window size must be AT LEAST 40 segments; any smaller window forces the sender to sit idle waiting for ACKs before the pipe is full again.\nREMEMBER: window size needed for full utilization = (bandwidth x RTT) / segment size -- this single ratio explains why long-fat networks (high bandwidth, high delay, e.g. satellite links) need very large TCP window scaling to perform well.\n\nWORKED EXAMPLE -- 3-way handshake sequence number bookkeeping\nClient sends SYN with seq=100 (no data). Server replies SYN+ACK with seq=300, ack=101. Client then sends ACK with seq=101, ack=301, plus 50 bytes of data.\n1. step: SYN consumes 1 sequence number even with 0 data bytes, so the server's ack for the client's SYN is 100+1=101 -- matches given value.\n2. step: The server's own SYN also consumes 1 sequence number, so the client's ack for the server's SYN is 300+1=301 -- matches given value.\n3. step: The client's next segment (with 50 data bytes) starts at seq=101; when the server acknowledges it, the next expected ack number will be 101+50=151, NOT 102 -- because data bytes (unlike SYN/FIN) consume sequence numbers 1-per-byte, not 1-per-segment.\n";
})();

(function(){ var t = window.GATE_DATA.questions['cn'].topics.find(function(t){return t.id==='cn-application';});
  t.theory.deep += "\n\nFROM ZERO: FOUNDATIONS\n• Client-server model. A **client** initiates a request; a **server** is a process that is always running, waiting to accept requests and respond -- e.g. a web browser (client) requests a page from a web server. Many clients can talk to one server at the same time using different port numbers/sockets.\n• Socket. A **socket** is the software endpoint an application uses to send/receive data over the network -- conceptually the 'door' between an application process and the transport layer, identified by an IP address + port number pair.\n• DNS. The **Domain Name System** is essentially the Internet's phonebook: it translates human-friendly domain names (like example.com) into numeric IP addresses that routers actually use, since routing tables are built on IP addresses, not names.\n• Round-trip time (RTT). The **RTT** is the time for a small packet to travel from client to server and back, used throughout application-layer protocols to estimate how many 'round trips' a task like a DNS lookup or an HTTP page fetch will cost.\n\nEVERY EDGE CASE\n• Recursive vs iterative DNS queries -- who does the walking. In a **recursive** query, the queried server takes full responsibility for chasing down the answer itself and returns only the final result (this is what a client sends to its local/recursive resolver). In an **iterative** query, the queried server may reply with 'I don't know, but ask this other server' -- a referral, not a final answer (this is what the local resolver sends to root, then TLD, then authoritative servers).\nGATE TRAP: a client typically issues exactly ONE recursive query and gets back one final answer; the local DNS resolver is the one that does multiple iterative round trips down the hierarchy. Assuming the client itself walks the hierarchy is a common wrong answer choice.\n• Counting RTTs for a DNS + HTTP fetch. A classic GATE numerical asks for total time to fetch a web page when the domain is NOT already cached: this needs (a) RTTs for DNS resolution (each hierarchy hop it must query fresh costs one RTT) PLUS (b) RTTs for the actual TCP handshake and HTTP request/response.\nFORMULA: Total time = (DNS RTTs) x RTT_dns + (TCP setup, usually 1 RTT) + (HTTP request/response, usually 1 RTT) x (objects, if non-persistent)\n• Non-persistent vs persistent vs pipelined HTTP -- RTT cost per object matters a lot. **Non-persistent HTTP** opens (and closes) a brand-new TCP connection for every single object on a page: each object costs 1 RTT for TCP setup + 1 RTT for the GET/response = 2 RTT per object. **Persistent HTTP without pipelining** reuses one TCP connection for all objects but still waits for each response before requesting the next: 1 RTT for setup + 1 RTT for the base HTML + 1 RTT PER remaining object. **Persistent HTTP WITH pipelining** sends all requests back-to-back without waiting: 1 RTT setup + 1 RTT for base HTML + 1 RTT total for ALL remaining objects together (since they're requested in a batch).\nGATE TRAP: for a page with 1 base HTML file referencing n embedded objects, non-persistent costs (n+1) x 2 RTT total, persistent-no-pipelining costs (n+2) RTT, and pipelined persistent costs only 3 RTT regardless of how large n is -- picking the wrong mode formula is the single biggest scoring risk in this sub-area.\n• DNS caching changes the RTT count. If a DNS record is already cached locally (Time-To-Live, TTL, not yet expired), the lookup costs 0 extra RTTs; a question that says 'assume the domain is cached' removes the entire DNS-lookup RTT term from the total.\n• SMTP push vs HTTP/FTP pull-ish nuance. **SMTP** (mail transfer) always PUSHES data from the sending mail server to the receiving mail server -- the sender initiates the TCP connection. Retrieving mail from your own mailbox to a client uses a separate PULL protocol like **POP3** (download-and-typically-delete) or **IMAP** (keeps mail on server, supports folders/partial download) -- SMTP itself is never used by a client to fetch mail.\nGATE TRAP: a question asking 'which protocol does an email client use to download mail from its mailbox' is testing that the answer is POP3/IMAP, NOT SMTP -- SMTP only pushes mail between servers (and from client to its outgoing server).\n• FTP's two connections. FTP uses TWO separate TCP connections: a **control connection** (port 21, stays open for the whole session, carries commands like USER, PASS, RETR) and a **data connection** (port 20 in active mode, opened fresh for each file transfer or directory listing) -- unlike HTTP which multiplexes everything over one kind of connection.\n• UDP-based application protocols and why. **DNS** primarily uses UDP (fast, single-packet query/response, small overhead; falls back to TCP only for large responses like zone transfers). Streaming/VoIP applications often use UDP because a late-arriving retransmitted packet is USELESS for real-time playback -- better to drop it than delay everything waiting for it, which is why TCP's reliability guarantee is actually undesirable there.\n\nWORKED EXAMPLE -- total time to fetch a web page, non-persistent HTTP, uncached DNS\nA browser must first resolve a domain not in any cache (this requires querying a local resolver, which then does an iterative walk: root -> TLD -> authoritative, i.e. 3 iterative RTTs from resolver to hierarchy, but the CLIENT itself pays only 1 RTT to talk to its resolver and get the final answer back). Assume: 1 RTT for the client-to-resolver recursive round trip covers the whole DNS phase from the client's point of view (the iterative hops happen on the resolver's own time in parallel/behind that single client RTT in the simplified GATE model). The base HTML page references 4 embedded images, and the browser uses non-persistent HTTP with NO parallel connections.\n1. step: DNS resolution = 1 RTT (client-resolver recursive query, uncached).\n2. step: Base HTML object: 1 RTT to set up TCP + 1 RTT to GET the HTML = 2 RTT.\n3. step: Each of the 4 images independently needs its own new TCP connection (non-persistent): 2 RTT each x 4 images = 8 RTT.\n4. step: Total = 1 (DNS) + 2 (base HTML) + 8 (4 images) = 11 RTT.\nKEY: total RTTs for non-persistent HTTP with n embedded objects (plus the base page) = 1 (DNS, if uncached) + 2 x (n+1).\nGATE TRAP: forgetting the DNS RTT term entirely when the question does not explicitly say 'assume DNS is cached' is a very common one-mark loss -- always check whether caching is stated before dropping that term.\n\n\nWORKED EXAMPLE -- same page, persistent HTTP with pipelining\nSame page as above (1 base HTML + 4 images), same uncached DNS, but now using persistent HTTP with pipelining.\n1. step: DNS resolution = 1 RTT (unchanged, DNS caching has nothing to do with the HTTP connection mode).\n2. step: 1 RTT to set up the single persistent TCP connection.\n3. step: 1 RTT to request and receive the base HTML.\n4. step: Now that the browser knows about all 4 images from the HTML, it pipelines all 4 image requests together in one batch: 1 RTT total for all of them (assuming they all fit in the pipe together).\n5. step: Total = 1 (DNS) + 1 (setup) + 1 (HTML) + 1 (all images pipelined) = 4 RTT.\nGATE TRAP: the number of embedded objects (4 here) does NOT appear anywhere in the pipelined total -- students who write '1 RTT per image' even under pipelining are reverting to the non-pipelined persistent formula by mistake; pipelining's whole point is that the object count drops out of the RTT count (though total bytes transferred obviously still scale with object count/size).\n\nWORKED EXAMPLE -- classifying a protocol to its correct transport and RTT behaviour\n1. step: 'A live video call where a late packet is worthless' -> UDP-based (e.g. RTP over UDP), because retransmission delay would hurt more than an occasional dropped frame.\n2. step: 'Downloading a large file that must be byte-perfect' -> TCP-based (e.g. HTTP over TCP, or FTP's data connection), because correctness matters more than a small delay.\n3. step: 'A DNS query for a single short name lookup' -> UDP (single packet, no connection setup overhead needed), with a TCP fallback reserved for oversized responses.\n";
})();
